...
import { IProperty, Property, UnitType, Furnishing } from 'app/shared/model/property.model';
...
describe('Service Tests', () => {
  describe('Property Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Property(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', UnitType.VILLA, 0, Furnishing.FURNISHED, 0, 0, 0);
    });
