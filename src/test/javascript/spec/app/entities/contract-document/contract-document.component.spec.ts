...
import { ContractDocumentComponent } from 'app/entities/contract-document/contract-document.component';
...
describe('Component Tests', () => {
  describe('ContractDocument Management Component', () => {
    let comp: ContractDocumentComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ContractDocumentComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.contractDocuments[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
