...
import { TenantContractComponent } from 'app/entities/tenant-contract/tenant-contract.component';
...
describe('Component Tests', () => {
  describe('TenantContract Management Component', () => {
    let comp: TenantContractComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TenantContractComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tenantContracts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
