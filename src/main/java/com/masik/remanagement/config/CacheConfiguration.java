package com.masik.remanagement.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.masik.remanagement.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.masik.remanagement.repository.UserRepository.USERS_BY_EMAIL_CACHE);
